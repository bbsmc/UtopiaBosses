...
public class BlockEntityRegistry {
    ...
    public static volatile BlockEntityType<SunflowerAltarBlockEntity> SUNFLOWER_ALTAR_BLOCK_ENTITY;
    ...
    public static void registerBlockEntities() {
        ...
        try {
            ...
            if (BlockRegistry.SUNFLOWER_ALTAR != null) {
                SUNFLOWER_ALTAR_BLOCK_ENTITY = Registry.register(
                        Registries.BLOCK_ENTITY_TYPE,
                        new Identifier(Utopiabosses.MOD_ID, "sunflower_altar"),
                        BlockEntityType.Builder.create(
                                SunflowerAltarBlockEntity::new,
                                BlockRegistry.SUNFLOWER_ALTAR).build(null)
                );
                Utopiabosses.LOGGER.info("已注册方块实体：SUNFLOWER_ALTAR_BLOCK_ENTITY");
            } else {
                Utopiabosses.LOGGER.error("SUNFLOWER_ALTAR为null，无法注册方块实体！");
            }
