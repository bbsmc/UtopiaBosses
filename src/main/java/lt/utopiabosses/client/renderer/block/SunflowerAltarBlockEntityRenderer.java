...
public class SunflowerAltarBlockEntityRenderer implements BlockEntityRenderer<SunflowerAltarBlockEntity> {

    public SunflowerAltarBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }
    
    @Override
    public void render(SunflowerAltarBlockEntity entity, float tickDelta, MatrixStack matrices,
