...
public class SunflowerBossModel extends DefaultedEntityGeoModel<SunflowerBossEntity> {
    // 定义可能的资源路径常量，便于排错
    ...
    private static final Identifier ANIMATION_RESOURCE = new Identifier(Utopiabosses.MOD_ID, "animations/sunflower_boss.animation.json");

    public SunflowerBossModel() {
        super(new Identifier(Utopiabosses.MOD_ID, "sunflower_boss"));
        // 构造函数中输出资源路径，便于排错
